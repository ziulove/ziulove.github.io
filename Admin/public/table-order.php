				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">УПРАВЛЕНИЕ ЗАКАЗАМИ</div>
						</div>
					...
					<div class="table-responsive"> 
						...
						<br>
						<p align="center">Сейчас у Вас нет заказов!</p>
						<br>
					</div>
				</div>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<span class="badge badge-success">ОБРАБОТАТЬ</span>
										<?php } else if ($data['status'] == '2') { ?>
										<span class="badge">&nbsp;ОТМЕНИТЬ&nbsp;</span>
										<?php } else { ?>
									...
									<td>
									    ...
									    <a href="manage-order.php?id=<?php echo $data['id'];?>" onclick="return confirm('Вы действительно хотите удалить этот заказ?')" >
