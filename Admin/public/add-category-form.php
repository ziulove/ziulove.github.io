		...
		<div class="section"> 
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">ДОБАВИТЬ КАТЕГОРИЮ</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="category_name" id="category_name" class="form-control" placeholder="Название Категории" required>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="regular1" class="control-label">Изображение Категории ( jpg / png) *</label>
				...
				<div class="pmd-card-actions">
					<p align="right">
					<button type="submit" class="btn pmd-ripple-effect btn-danger" name="btnAdd">Применить</button>
					</p>
				</div>
