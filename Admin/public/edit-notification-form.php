...
<div id="content" class="pmd-content content-area dashboard">
    ...
    <div class="container-fluid full-width-container">
        ...
        <ol class="breadcrumb text-left">
          ...
          <li class="active">Добавить Уведомление</li>
        </ol>
        <!--breadcrum end-->
        ...
        <div class="section"> 
            ...
            <div class="pmd-card pmd-z-depth">
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="lead">ДОБАВИТЬ УВЕДОМЛЕНИЕ</div>
                        </div>
                    </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield">
                                ...
                                <input type="text" name="link" id="link" class="form-control" placeholder="https://www.youtube.com/c/ErikDeliyev" value="<?php echo $data['link']; ?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="pmd-card-actions">
                    <p align="right">
                    <button type="submit" class="btn pmd-ripple-effect btn-danger" name="btnEdit">Применить</button>
                    </p>
                </div>
