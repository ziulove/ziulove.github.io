        ...
        <div class="section"> 
                ...
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="lead">Валюта и Налог</div>
                        </div>
                    </div>
                    ...
                    <div class="group-fields clearfix row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <br>
                            <button data-target="#currency-dialog" data-toggle="modal" class="btn pmd-btn-flat pmd-ripple-effect btn-primary" type="button">Добавить</button>
                        </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield">
                                ...
                                <button data-target="#shipping-dialog" data-toggle="modal" class="btn pmd-btn-flat pmd-ripple-effect btn-primary" type="button">Добавить</button>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header pmd-modal-bordered">
                                                ...
                                                <h2 class="pmd-card-title-text">Способы Доставки</h2>
                                            </div>
                                            ...
                                            <div class="pmd-modal-action">
                                                ...
                                                <button class="btn pmd-ripple-effect btn-danger" type="submit" name="submit_shipping">Добавить</button>
                                                </div>
                                            </div>
                                        </form>
                                        </div>
            ...
            <div class="pmd-card pmd-z-depth">
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="lead">УВЕДОМЛЕНИЯ</div>
                        </div>
                    </div>
                ...
                <div class="pmd-card-actions">
                    <p align="right">
                    <button type="submit" class="btn pmd-ripple-effect btn-danger" name="submit_settings">Применить</button>
                    </p>
                </div>                    
                                ...
                                <div tabindex="-1" class="modal fade" id="currency-dialog" style="display: none;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header pmd-modal-bordered">
                                                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                <h2 class="pmd-card-title-text">Добавить Валюту</h2>
                                            </div>
                                            <form id="validationForm" method="post">            
                                            <div class="modal-body">
                                                    <div class="form-group pmd-textfield">
                                                        <label class="control-label">Код Валюты</label>
                                            ...
                                            <div class="pmd-modal-action">
                                                <div align="right">
                                                <button data-dismiss="modal" class="btn pmd-ripple-effect btn-default" type="button">Отмена</button>
                                                <button class="btn pmd-ripple-effect btn-danger" type="submit" name="submit_currency">Добавить</button>
                                                </div>
                                            </div>
                                        </form>
                                        </div>
