...
<footer class="admin-footer">
 <div class="container-fluid">
 	<ul class="list-unstyled list-inline">
	 	<li>
			<span class="pmd-card-subtitle-text">Erik Deliyev &copy; <span class="auto-update-year"></span>. All Rights Reserved.</span>
			<h3 class="pmd-card-subtitle-text"><a href="https://www.youtube.com/c/ErikDeliyev" target="_blank">Приложение ShopApp версия 2.1</a></h3>
        </li>
        <li class="pull-right for-support">
			<a href="mailto:erikdeliyev@gmail.com">
          		<div>
	...
	<path fill="#A5A4A4" d="M32.437,5.568C28.869,2,24.098-0.005,19.005-0.005S9.182,2,5.573,5.568C2.005,9.177,0,13.908,0,19
		...
		c3.003-3.003,7.022-4.695,11.294-4.695c4.272,0,8.291,1.649,11.293,4.695C36.56,13.924,36.56,24.075,30.299,30.294z"/>
            	...
            	<div>
				  ...
				  <h3 class="pmd-card-subtitle-text">erikdeliyev@gmail.com</h3>
				</div>
            </a>
        </li>
    </ul>
